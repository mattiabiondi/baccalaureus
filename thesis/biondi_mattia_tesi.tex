...
The BIOS Reserved 2 register was set to point the reserved space at the end of the first frame of RAM, at address \texttt{0x2000.0FFF}.

In $\mu$MPS3, at boot/reset time, the Bootstrap BIOS Services set up the BIOS Reserved 1 register to point the bottom of the BIOS Data Page (\texttt{0x0FFF.F000}) [\autoref{fig:bios_data_page}], where the reserved exception state space for processor 0 starts.
